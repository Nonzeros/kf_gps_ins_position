...
void CKFApp::Init(const CSINS &sins0, int grade)
{
	...
	// Pmin.Set2(fPHI(0.0,0.0),  fXXX(0.000),  fdPOS(0.0),  fDPH3(0.0),  fUG3(0), fXXX(0.00),  0.000);
	Pmin.Set2(fPHI(0.0001,1.0),  fXXX(0.001),  fdPOS(0.1),  fDPH3(0.1),  fUG3(10), fXXX(0.01),  0.0001);
	Pk.SetDiag2(fPHI(0.4,0.0),  fXXX(0.001),  fdPOS(0.001),  fDPH3(0.0001),  fMG3(0.00), fXXX(0.00),  0.0);
	Qt.Set2(fDPSH3(0.8),  fUGPSHZ3(0.8),  fOOO,  fOO6,	fOOO, 0.05);
	// Rt.Set2(fXXZ(0.01,2.0),   fdLLH(0.05,0.0));
	Rt.Set2(fXXZ(5,4),   fdLLH(1.5,0.1));
	Rmax = Rt*100;  Rmin = Rt*0.1;  Rb = 0.1;
	FBTau.Set(fXX9(0.01),  fXX6(0.5),  fINF3, INF);
