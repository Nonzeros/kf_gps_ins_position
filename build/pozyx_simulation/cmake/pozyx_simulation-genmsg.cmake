...
set(MSG_I_FLAGS "-Ipozyx_simulation:/home/ouyy/MyRosGuideCar/src/pozyx_simulation/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ouyy/MyRosGuideCar/src/pozyx_simulation/msg/uwb_data.msg" NAME_WE)
add_custom_target(_pozyx_simulation_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pozyx_simulation" "/home/ouyy/MyRosGuideCar/src/pozyx_simulation/msg/uwb_data.msg" ""
)
...
_generate_msg_cpp(pozyx_simulation
  "/home/ouyy/MyRosGuideCar/src/pozyx_simulation/msg/uwb_data.msg"
  "${MSG_I_FLAGS}"
  ""
