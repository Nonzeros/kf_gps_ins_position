...
(cl:defmethod cl:initialize-instance :after ((m <add-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name server_client-srv:<add-request> is deprecated: use server_client-srv:add-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <add-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name server_client-srv:<add-response> is deprecated: use server_client-srv:add-response instead.")))
